...
export default async function BookingsPage() {
  ...
  const bookings: Booking[] = data.map(rt => ({
      id: rt.booking_id.toString(),
      resourceId: rt.resource_id.toString(),
      userId: rt.user_id.toString(),
      startDateTime: rt.start_datetime?.toISOString() ?? '',
      endDateTime: rt.end_datetime?.toISOString() ?? '',
      status: (rt.status ?? 'Pending') as Booking['status'],
      approverId: rt.approver_id?.toString() ?? '',
