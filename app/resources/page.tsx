...
export default async function ResourcesPage() {
  ...
  const resource = data.map(rt => ({
      id: rt.resource_id.toString(),
      name: rt.resource_name,
      resourceTypeId: rt.resource_type_id.toString(),
      buildingId: rt.building_id.toString(),
      floorNumber: rt.floor_number ?? 0,
      description: rt.description ?? '',
  }));

  return <ResourcesClientPage initialResource={resource}/>;
}
